                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-8 mt-5">
                            <h3 className='lead text-center fs-5' style={{ color: 'white'}}>Our Service</h3>
                            <h1 className='display-5 text-center mb-4' style={{ color: 'white'}}>Our <b>Symbiote</b> Operation</h1>
                        </div>
                    </div>
